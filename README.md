...
| Skill | Description |
|---|---|
| `linkit360-checking-code-coverage` | Measure unit test coverage (Go, Node.js, Python, Java) |
| `linkit360-checking-code-duplication` | Detect duplicate code blocks and report duplication % |
| `linkit360-checking-vulnerabilities` | Scan for security vulnerabilities (OWASP Top 10) |
| `linkit360-checking-security-hotspot` | Identify security-sensitive code requiring manual review |
| `linkit360-refactoring-based-quality-gate` | Run all four checks, refactor to meet thresholds, report before/after |
